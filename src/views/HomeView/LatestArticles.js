    ...
    return (
        <div className="latest-articles">
            <div className="d-flex mb-4 align-items-center justify-content-between">
                <h2 className="app-title m-0"><span>Latest</span> Articles</h2>
                <div className="slide-controls">
                    <div className="prev" onClick={previous}><i className="fas fa-chevron-left"></i></div>
                    <div className="next" onClick={next}><i className="fas fa-chevron-right"></i></div>
                </div>
            </div>
            <Carousel
